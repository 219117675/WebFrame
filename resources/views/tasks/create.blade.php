            ...
            <form method="POST" action="{{ route('tasks.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description" rows="4"
                        class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:ring-blue-500 focus:border-blue-500"></textarea>
                    @error('description')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4 flex items-center space-x-3">
                    <input id="completed" name="completed" type="checkbox" class="rounded border-gray-300 dark:border-gray-600 focus:ring-blue-500" />
                    <label for="completed" class="text-gray-700 dark:text-gray-300">Done</label>
                </div>
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="submit" class="px-4 py-2 bg-blue-600 rounded text-white hover:bg-blue-700">Save Task</button>
                </div>
            </form>
        </div>
    </div>
